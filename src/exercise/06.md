...
This lesson was great in showcasing small performance improvements and
continually increased the complexity. I really enjoyed the Separate Contexts
reminder to extract a given context value and only wrap the children that need
it as well as the HOC lesson to extract the cell that is being rendered.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Performance%20%E2%9A%A1&e=06%3A%20Fix%20%22perf%20death%20by%20a%20thousand%20cuts%22&em=mklimek15%40gmail.com).
