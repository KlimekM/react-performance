...
### Learnings
This was a great and insightful lesson on virtualizing or windowing really large lists. I've never used react-virtual, so it was cool to see under the hood that the DOM only returns a set number of li elements that then get updated based on the scroll position.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Performance%20%E2%9A%A1&e=04%3A%20Window%20large%20lists%20with%20react-virtual&em=mklimek15%40gmail.com).
