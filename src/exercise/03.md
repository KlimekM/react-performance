...
This was probably my favorite lesson to date, specifically how Kent introduced
the custom comparator in the 1st extra credit, and then led us to using
primitive values in the 2nd extra credit. This made things click for me and
makes so much sense when realizing that React does shallow compares and it is
much easier to memoize the primitive values vs the objects that were previously
passed
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Performance%20%E2%9A%A1&e=03%3A%20React.memo%20for%20reducing%20unnecessary%20re-renders&em=mklimek15%40gmail.com).
