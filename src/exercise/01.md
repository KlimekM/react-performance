...
React.lazy and especially the eager loading is such an easy performance gain and this module was fun to play
around with even having used it in the past. I enjoyed messing with the
placement on React.Suspense to see how it effects the waterfall/network and
coverage tabs.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Performance%20%E2%9A%A1&e=01%3A%20Code%20splitting&em=mklimek15%40gmail.com).
