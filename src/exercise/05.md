...
The first portion of this exercise using useMemo within the context value makes
a lot of sense and Kent's deep dive into Object.is and the comparison that is
being made on the given Array object causing the re-renders amde that click. The
split context extra credit was also a lot of fun and not a pattern that I've
seen before but is super flexible thanks to hooks and allows for a minor
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Performance%20%E2%9A%A1&e=05%3A%20Optimize%20context%20value&em=mklimek15%40gmail.com).
